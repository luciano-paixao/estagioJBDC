...
import DAO.AproveitamentoProfissionalDAO;
...
public class AproveitamentoController {
    ...
    private AproveitamentoProfissionalDAO aproveitamentoDAO;

    public AproveitamentoController(TelaCadastroAproveitamento view) {
        this.view = view;
        this.aproveitamentoDAO = new AproveitamentoProfissionalDAO(); // Instanciando o DAO
        inicializarEventos();
    }
    ...
    private void salvarAproveitamento() {
        ...
        try {
            ...
            aproveitamentoDAO.cadastrarAproveitamento(apro);
